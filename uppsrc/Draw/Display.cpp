...
const Display& ColorDisplay() {
    return Single<ColorDisplayNull>();
}
...
const Display& SizeTextDisplay() {
    return Single<SizeTextDisplayCls>();
}
...
const Display& CenteredImageDisplay() {
    return Single<CenteredImageDisplayCls>();
}
...
const Display& FittedImageDisplay() {
    return Single<FittedImageDisplayCls>();
}
...
const Display& DrawingDisplay() {
    return Single<DrawingDisplayCls>();
}
