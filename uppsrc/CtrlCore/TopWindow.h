...
public:
    ...
    TopWindow& Zoomable(bool b = true) {
        MinimizeBox(b);
        return MaximizeBox(b);
    }
    TopWindow& NoZoomable() {
        return Zoomable(false);
    }
    ...
    TopWindow& NoCloseBox(bool b = true) {
        noclosebox = b;
        return *this;
    }
