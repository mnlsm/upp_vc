...
String PasteClip::Get() const {
    return data;
}

PasteClip::operator String() const {
    return data;
}

String PasteClip::operator ~() const {
    return data;
}

void   PasteClip::Reject() {
    accepted = false;
    data.Clear();
}

int PasteClip::GetAction() const {
    return action;
}
int PasteClip::GetAllowedActions() const {
    return allowed;
}
void PasteClip::SetAction(int x) {
    action = x;
}

bool PasteClip::IsAccepted() const {
    return accepted;
}

bool PasteClip::IsQuery() const {
    return !paste;
}

bool PasteClip::IsPaste() const {
    return paste;
}
