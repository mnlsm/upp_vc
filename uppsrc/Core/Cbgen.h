...
class Callback : Moveable< Callback > {
    ...
    void Retain() const {
        if(action) AtomicInc(action->count);
    }
    void Release() {
        if(action  && AtomicDec(action->count) == 0) delete action;
    }
...
public:
    ...
    explicit Callback(CallbackAction  *newaction) {
        action = newaction;
    }
    Callback() {
        action = NULL;
...
public:
    ...
    void Execute(P1 p1) const {
        if(action) action->Execute(p1);
    }
    void operator()(P1 p1) const {
        Execute(p1);
    }

    explicit Callback1(Callback1Action <P1> *newaction) {
        action = newaction;
    }
    Callback1() {
        action = NULL;
...
public:
    ...
    void Execute(P1 p1, P2 p2) const {
        if(action) action->Execute(p1, p2);
    }
    void operator()(P1 p1, P2 p2) const {
        Execute(p1, p2);
    }

    explicit Callback2(Callback2Action <P1, P2> *newaction) {
        action = newaction;
    }
    Callback2() {
        action = NULL;
...
struct Callback3MethodActionPte : public Callback3Action<P1, P2, P3> {
    ...
    void Execute(P1 p1, P2 p2, P3 p3) {
        if(object)(object->*method)(p1, p2, p3);
    }
    bool IsValid() const {
        return object;
    }
...
public:
    ...
    void Execute(P1 p1, P2 p2, P3 p3) const {
        if(action) action->Execute(p1, p2, p3);
    }
    void operator()(P1 p1, P2 p2, P3 p3) const {
        Execute(p1, p2, p3);
    }

    explicit Callback3(Callback3Action <P1, P2, P3> *newaction) {
        action = newaction;
    }
    Callback3() {
        action = NULL;
...
struct Callback4MethodActionPte : public Callback4Action<P1, P2, P3, P4> {
    ...
    void Execute(P1 p1, P2 p2, P3 p3, P4 p4) {
        if(object)(object->*method)(p1, p2, p3, p4);
    }
    bool IsValid() const {
        return object;
    }
...
public:
    ...
    void Execute(P1 p1, P2 p2, P3 p3, P4 p4) const {
        if(action) action->Execute(p1, p2, p3, p4);
    }
    void operator()(P1 p1, P2 p2, P3 p3, P4 p4) const {
        Execute(p1, p2, p3, p4);
    }

    explicit Callback4(Callback4Action <P1, P2, P3, P4> *newaction) {
        action = newaction;
    }
    Callback4() {
        action = NULL;
...
struct GateMethodActionPte : public GateAction {
    ...
    bool Execute() {
        return object ? (object->*method)() : false;
    }
    bool IsValid() const {
        return object;
    }
...
class Gate : Moveable< Gate > {
    ...
    void Retain() const {
        if(action && (void *)action != (void *)1) AtomicInc(action->count);
    }
    void Release() {
        if(action && (void *)action != (void *)1 && AtomicDec(action->count) == 0) delete action;
    }
...
public:
    ...
    operator bool() const {
        return (void *)action != (void *)1 && action && action->IsValid();
    }
    bool Execute() const;
    bool operator()() const {
        return Execute();
    ...
    Gate(bool b) {
        action = (GateAction *)(uintptr_t)b;
    }

    explicit Gate(GateAction  *newaction) {
        action = newaction;
    }
    Gate() {
        action = NULL;
...
struct Gate1MethodActionPte : public Gate1Action<P1> {
    ...
    bool Execute(P1 p1) {
        return object ? (object->*method)(p1) : false;
    }
    bool IsValid() const {
        return object;
    }
...
public:
    ...
    Gate1(bool b) {
        action = (Gate1Action<P1> *)(uintptr_t)b;
    }

    explicit Gate1(Gate1Action <P1> *newaction) {
        action = newaction;
    }
    Gate1() {
        action = NULL;
...
struct Gate2MethodActionPte : public Gate2Action<P1, P2> {
    ...
    bool Execute(P1 p1, P2 p2) {
        return object ? (object->*method)(p1, p2) : false;
    }
    bool IsValid() const {
        return object;
    }
...
public:
    ...
    bool operator()(P1 p1, P2 p2) const {
        return Execute(p1, p2);
    }
    void ClearTrue() {
        Clear();
        action = (Gate2Action<P1, P2> *)1;
    }
    void ClearFalse() {
        Clear();
    }
    ...
    Gate2(bool b) {
        action = (Gate2Action<P1, P2> *)(uintptr_t)b;
    }

    explicit Gate2(Gate2Action <P1, P2> *newaction) {
        action = newaction;
    }
    Gate2() {
        action = NULL;
...
struct Gate3MethodActionPte : public Gate3Action<P1, P2, P3> {
    ...
    bool Execute(P1 p1, P2 p2, P3 p3) {
        return object ? (object->*method)(p1, p2, p3) : false;
    }
    bool IsValid() const {
        return object;
    }
...
public:
    ...
    bool operator()(P1 p1, P2 p2, P3 p3) const {
        return Execute(p1, p2, p3);
    }
    void ClearTrue() {
        Clear();
        action = (Gate3Action<P1, P2, P3> *)1;
    }
    void ClearFalse() {
        Clear();
    }
    ...
    Gate3(bool b) {
        action = (Gate3Action<P1, P2, P3> *)(uintptr_t)b;
    }

    explicit Gate3(Gate3Action <P1, P2, P3> *newaction) {
        action = newaction;
    }
    Gate3() {
        action = NULL;
...
struct Gate4MethodActionPte : public Gate4Action<P1, P2, P3, P4> {
    ...
    bool Execute(P1 p1, P2 p2, P3 p3, P4 p4) {
        return object ? (object->*method)(p1, p2, p3, p4) : false;
    }
    bool IsValid() const {
        return object;
    }
...
struct Gate4MethodAction : public Gate4Action<P1, P2, P3, P4> {
    ...
    bool Execute(P1 p1, P2 p2, P3 p3, P4 p4) {
        return (object->*method)(p1, p2, p3, p4);
    }
...
public:
    ...
    void ClearTrue() {
        Clear();
        action = (Gate4Action<P1, P2, P3, P4> *)1;
    }
    void ClearFalse() {
        Clear();
    }
    ...
    Gate4(bool b) {
        action = (Gate4Action<P1, P2, P3, P4> *)(uintptr_t)b;
    }

    explicit Gate4(Gate4Action <P1, P2, P3, P4> *newaction) {
        action = newaction;
    }
    Gate4() {
        action = NULL;
