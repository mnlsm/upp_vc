...
struct CharSetData {
    ...
    int  ToUnicode(int chr) {
        return (byte)chr < 128 ? (byte)chr : table[(byte)chr - 128];
    }
...
word UnicodeCombine(word chr, word combine) {
    ...
    switch(combine) {
    case 0x311:
        return sComb(comb311, chr);
    case 0x31B:
        return sComb(comb31B, chr);
    case 0x326:
        return sComb(comb326, chr);
    case 0x327:
        return sComb(comb327, chr);
    case 0x328:
        return sComb(comb328, chr);
    case 0x653:
        return sComb(comb653, chr);
    case 0x654:
        return sComb(comb654, chr);
    case 0x655:
        return sComb(comb655, chr);
    }
    return 0;
}
