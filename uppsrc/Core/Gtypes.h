...
struct Size_ : Moveable< Size_<T> > {
    ...
    friend Size_  min(Size_ a, Size_ b) {
        return Size_(min(a.cx, b.cx), min(a.cy, b.cy));
    }
    friend Size_  max(Size_ a, Size_ b) {
        return Size_(max(a.cx, b.cx), max(a.cy, b.cy));
    }
    ...
    friend T      Squared(Size_ a) {
        return a.cx * a.cx + a.cy * a.cy;
    }
    friend double Length(Size_ a) {
        return hypot(a.cx, a.cy);
    }

    unsigned      GetHashValue() const {
        return UPP::GetHashValue(cx) ^ UPP::GetHashValue(cy);
    }
    ...
    operator Value() const {
        return RichValue<Size_>(*this);
    }
    Size_(const Value& src) {
        *this = RichValue<Size_>::Extract(src);
    }
    ...
    operator SIZE*() {
        ASSERT(sizeof(*this) == sizeof(SIZE));
        return (SIZE*)this;
    }
    ...
    explicit Size_(LONG lParam) {
        cx = (T)(int16)LOWORD(lParam);
        cy = (T)(int16)HIWORD(lParam);
    }
};
...
struct Point_ : Moveable< Point_<T> > {
    ...
    friend Sz     operator+(Sz a, Point_ b) {
        return Point_(a) + b;
    }
    friend Sz&    operator+=(Sz& a, Point_ b) {
        return a = a + b;
    ...
    friend Sz     operator-(Point_ a, Point_ b) {
        return a -= b;
    }
    friend Sz     operator-(Sz a, Point_ b) {
        return Point_(a) - b;
    ...
    friend Point_ min(Point_ a, Point_ b) {
        return Point_(min(a.x, b.x), min(a.y, b.y));
    }
    friend Point_ max(Point_ a, Point_ b) {
        return Point_(max(a.x, b.x), max(a.y, b.y));
    }
    ...
    unsigned      GetHashValue() const {
        return UPP::GetHashValue(x) ^ UPP::GetHashValue(y);
    }
    ...
    operator Value() const {
        return RichValue<Point_>(*this);
    }
    /*explicit */Point_(const Value& src) {
        *this = RichValue<Point_>::Extract(src);
    }
    ...
    operator POINT*() {
        ASSERT(sizeof(*this) == sizeof(POINT));
        return (POINT*)this;
    }
    ...
    explicit Point_(LONG lParam) {
        x = (T)(int16)LOWORD(lParam);
        y = (T)(int16)HIWORD(lParam);
    }
};
...
struct Rect_ : Moveable< Rect_<T> > {
    ...
    Pt     TopCenter() const {
        return Pt(GHalf_(left + right), top);
    }
    Pt     TopRight() const {
        return Pt(right, top);
    }
    Pt     CenterLeft() const {
        return Pt(left, GHalf_(top + bottom));
    }
    Pt     CenterPoint() const {
        return Pt(GHalf_(left + right), GHalf_(top + bottom));
    }
    Pt     CenterRight() const {
        return Pt(right, GHalf_(top + bottom));
    }
    Pt     BottomLeft() const {
        return Pt(left, bottom);
    }
    Pt     BottomCenter() const {
        return Pt(GHalf_(left + right), bottom);
    }
    ...
    Pt     CenterPos(Sz sz) const {
        return CenterPos(sz.cx, sz.cy);
    }
    Rect_  CenterRect(Sz sz) const {
        return Rect_(CenterPos(sz), sz);
    }
    Rect_  CenterRect(T cx, T cy) const {
        return CenterRect(Sz(cx, cy));
    }
    ...
    void   Deflate(const Rect_& r) {
        Deflate(r.left, r.top, r.right, r.bottom);
    }
    ...
    void   OffsetHorz(T dx) {
        left += dx;
        right += dx;
    }
    void   OffsetVert(T dy) {
        top += dy;
        bottom += dy;
    }
    void   Offset(T dx, T dy) {
    ...
    Rect_  OffsetedHorz(T dx) const {
        Rect_ r = *this;
        r.OffsetHorz(dx);
        return r;
    }
    Rect_  OffsetedVert(T dy) const {
        Rect_ r = *this;
        r.OffsetVert(dy);
        return r;
    }
    Rect_  Offseted(T dx, T dy) const {
        Rect_ r = *this;
        r.Offset(dx, dy);
        return r;
    }
    Rect_  Offseted(Sz sz) const {
        Rect_ r = *this;
        r.Offset(sz);
        return r;
    }
    Rect_  Offseted(Pt p) const {
        Rect_ r = *this;
        r.Offset(p);
        return r;
    }
    ...
    friend Rect_ operator+(Rect_ a, Sz b) {
        return a += b;
    }
    friend Rect_ operator+(Sz a, Rect_ b) {
        return b += a;
    }
    friend Rect_ operator+(Rect_ a, Pt b) {
        return a += b;
    }
    friend Rect_ operator+(Pt a, Rect_ b) {
        return b += a;
    }
    friend Rect_ operator+(Rect_ a, const Rect_& b) {
        return a += b;
    }
    friend Rect_ operator-(Rect_ a, Sz b) {
        return a -= b;
    ...
    friend Rect_ operator|(Rect_ a, Rect_ b) {
        a.Union(b);
        return a;
    }
    friend Rect_ operator&(Rect_ a, Rect_ b) {
    ...
    friend bool  operator&&(const Rect_& a, const Rect_& b) {
        return a.Intersects(b);
    }
    friend bool  operator>=(const Rect_& a, Pt b) {
        return a.Contains(b);
    }
    friend bool  operator<=(Pt a, const Rect_& b) {
        return b.Contains(a);
    }
    friend bool  operator<=(const Rect_& a, const Rect_& b) {
        return b.Contains(a);
    }
    friend bool  operator>=(const Rect_& b, const Rect_& a) {
        return a.Contains(b);
    }

    friend const Rect_& Nvl(const Rect_& a, const Rect_& b) {
        return IsNull(a) ? b : a;
    }

    unsigned     GetHashValue() const {
        return UPP::GetHashValue(left) ^ UPP::GetHashValue(top) ^ UPP::GetHashValue(right) ^ UPP::GetHashValue(bottom);
    }
    ...
    Rect_(const Rect_<int>& r) {
        Set((T)r.left, (T)r.top, (T)r.right, (T)r.bottom);
    }
    ...
    operator Value() const {
        return RichValue<Rect_>(*this);
    }
    /*explicit */Rect_(const Value& src) {
        *this = RichValue<Rect_>::Extract(src);
    }
    ...
    operator const RECT*() const {
        ASSERT(sizeof(*this) == sizeof(RECT));
        return (RECT*)this;
    }
    operator RECT*() {
        ASSERT(sizeof(*this) == sizeof(RECT));
    ...
    Rect_(const RECT& rc) {
        Set((T)rc.left, (T)rc.top, (T)rc.right, (T)rc.bottom);
    }
};
...
template<> inline dword ValueTypeNo(const Size*) {
    return SIZE_V;
}
template<> inline dword ValueTypeNo(const Size16*) {
    return SIZE16_V;
}
template<> inline dword ValueTypeNo(const Size64*) {
    return SIZE64_V;
}
template<> inline dword ValueTypeNo(const Sizef*) {
    return SIZEF_V;
}
...
template<> inline dword ValueTypeNo(const Point*) {
    return POINT_V;
}
template<> inline dword ValueTypeNo(const Point16*) {
    return POINT16_V;
}
template<> inline dword ValueTypeNo(const Point64*) {
    return POINT64_V;
}
template<> inline dword ValueTypeNo(const Pointf*) {
    return POINTF_V;
}
...
template<> inline dword ValueTypeNo(const Rect*) {
    return RECT_V;
}
template<> inline dword ValueTypeNo(const Rect16*) {
    return RECT16_V;
}
template<> inline dword ValueTypeNo(const Rect64*) {
    return RECT64_V;
}
template<> inline dword ValueTypeNo(const Rectf*) {
    return RECTF_V;
}
...
inline Sizef operator*(Size sz, double a) {
    return Sizef(sz.cx * a, sz.cy * a);
}
inline Sizef operator*(double a, Size sz) {
    return Sizef(sz.cx * a, sz.cy * a);
}
inline Sizef operator/(Size sz, double a) {
    return Sizef(sz.cx / a, sz.cy / a);
}
inline Sizef operator*(Size sz, Sizef a) {
    return Sizef(sz.cx * a.cx, sz.cy * a.cy);
}
inline Sizef operator*(Sizef a, Size sz) {
    return Sizef(sz.cx * a.cx, sz.cy * a.cy);
}
inline Sizef operator/(Size sz, Sizef a) {
    return Sizef(sz.cx / a.cx, sz.cy / a.cy);
...
inline Sizef operator*(Size16 sz, double a) {
    return Sizef(sz.cx * a, sz.cy * a);
}
inline Sizef operator*(double a, Size16 sz) {
    return Sizef(sz.cx * a, sz.cy * a);
}
inline Sizef operator/(Size16 sz, double a) {
    return Sizef(sz.cx / a, sz.cy / a);
}
inline Sizef operator*(Size16 sz, Sizef a) {
    return Sizef(sz.cx * a.cx, sz.cy * a.cy);
}
inline Sizef operator*(Sizef a, Size16 sz) {
    return Sizef(sz.cx * a.cx, sz.cy * a.cy);
}
inline Sizef operator/(Size16 sz, Sizef a) {
    return Sizef(sz.cx / a.cx, sz.cy / a.cy);
...
inline Rect  RectSort(Point a, Point b) {
    return Rect(min(a, b), max(a, b) + 1);
}
inline Rectf RectfSort(Pointf a, Pointf b) {
    return Rectf(min(a, b), max(a, b));
}
...
inline Size GetFitSize(Size objsize, Size intosize) {
    return GetFitSize(objsize, intosize.cx, intosize.cy);
}
