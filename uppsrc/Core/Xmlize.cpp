...
template<> void Xmlize(XmlIO xml, Size& p) {
    XmlizeSize_(xml, p);
}
template<> void Xmlize(XmlIO xml, Size16& p) {
    XmlizeSize_(xml, p);
}
template<> void Xmlize(XmlIO xml, Size64& p) {
    XmlizeSize_(xml, p);
}
template<> void Xmlize(XmlIO xml, Sizef& p) {
    XmlizeSize_(xml, p);
}
...
template<> void Xmlize(XmlIO xml, Rect& p) {
    XmlizeRect_(xml, p);
}
template<> void Xmlize(XmlIO xml, Rect16& p) {
    XmlizeRect_(xml, p);
}
template<> void Xmlize(XmlIO xml, Rect64& p) {
    XmlizeRect_(xml, p);
}
template<> void Xmlize(XmlIO xml, Rectf& p) {
    XmlizeRect_(xml, p);
}
