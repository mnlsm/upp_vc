    ...
    if(text.GetPartCount() && (options & QTF_BODY)) {
        ...
        if(!(options & QTF_NOCHARSET)) {
            ...
            if(charset == CHARSET_UTF8)
                qtf << "_";
            else if(charset >= CHARSET_WIN1250 && charset <= CHARSET_WIN1258)
                qtf << (char)('0' + charset - CHARSET_WIN1250);
            else if(charset >= CHARSET_ISO8859_1 && charset <= CHARSET_ISO8859_16)
