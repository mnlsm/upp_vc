...
Size RichObjectType::GetPhysicalSize(const Value& data) const {
    return Size(0, 0);
}
...
Size RichObjectType::GetPixelSize(const Value& data) const {
    return Size(1, 1);
}
...
RichObjectType *RichObjectTypeDrawing() {
    return &Single<RichObjectTypeDrawingCls>();
}
...
RichObjectType *RichObjectTypePNG() {
    return &Single<RichObjectTypePNGCls>();
}
