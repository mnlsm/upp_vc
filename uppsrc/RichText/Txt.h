...
public:
    ...
    bool                  IsPara(int i) const {
        return part[i].Is<Para>();
    }
    ...
    Uuid                  GetParaStyle(int i) const {
        return part[i].Get<Para>().styleid;
    }
    ...
    void                  CatPick(pick_ RichTable& table) {
        SetPick(GetPartCount(), table);
    }
    void                  Set(int parai, const RichPara& p, const RichStyles& s);
    void                  Insert(int parai, const RichPara& p, const RichStyles& s);
    void                  Cat(const RichPara& p, const RichStyles& s) {
        Set(GetPartCount(), p, s);
    }
