...
struct AttrText {
    ...
    AttrText& Set(const char *s) {
        text = s;
        return *this;
    }
    AttrText& Set(const wchar *s) {
        text = s;
        return *this;
    }
    AttrText& Set(const WString& s) {
        text = s;
        return *this;
    }
    AttrText& operator=(const char *s) {
        text = s;
        return *this;
    }
    AttrText& operator=(const wchar *s) {
        text = s;
        return *this;
    }
    AttrText& operator=(const WString& s) {
        text = s;
        return *this;
    }
    AttrText& operator=(const String& s) {
        text = s.ToWString();
        return *this;
    }
...
public:
    ...
    void SetIcon(const Image& img, int spc = 4) {
        icon = img;
        lspc = spc;
    }
    ...
    void Set(const Display& d, const Image& m, int spc = 4) {
        SetIcon(m, spc);
        SetDisplay(d);
    }
