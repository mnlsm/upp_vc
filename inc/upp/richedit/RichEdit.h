...
public:
    UnitEdit& SetUnit(int _unit) {
        unit = _unit;
        return *this;
    }
    void      Set(int _unit, int d) {
        unit = _unit;
        SetData(d);
    }
...
public:
    ...
    static void   FixedLang(int lang) {
        fixedlang = lang;
    }
    ...
    RichText::FormatInfo GetFormatInfo() const {
        return formatinfo;
    }
    ...
    RichEdit&       SingleLine(bool b = true) {
        singleline = b;
        return *this;
    }
    RichEdit&       FontFaces(const Vector<int>& face);
    RichEdit&       ViewBorder(int cx) {
        viewborder = cx;
        Refresh();
        return *this;
    }
    RichEdit&       ShowCodes(Color c) {
        showcodes = c;
        Refresh();
        return *this;
    }
    ...
    RichEdit&       SpellCheck(bool b) {
        spellcheck = b;
        Refresh();
        return *this;
    }
    RichEdit&       SetZoom(int z) {
        zoom = z;
        Refresh();
        return *this;
    }
    RichEdit&       SetContext(void *ctx) {
        context = ctx;
        Refresh();
        return *this;
    }
...
public:
    RichEditWithToolBar& Extended(bool b = true) {
        extended = b;
        return *this;
    }
    RichEditWithToolBar& NoExtended() {
