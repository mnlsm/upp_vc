...
public:
    ...
    MenuItemBase&  LeftGap(int cx) {
        leftgap = cx;
        return *this;
    }
    MenuItemBase&  TextGap(int cx) {
        textgap = cx;
        return *this;
    }
    MenuItemBase&  SetFont(Font f) {
        font = f;
        return *this;
    }
    MenuItemBase&  Style(const MenuBar::Style *s) {
        style = s;
        return *this;
    }
    Font           GetFont() const {
    ...
    MenuItemBase&  MaxIconSize(Size sz) {
        maxiconsize = sz;
        return *this;
    }
...
public:
    ...
    void SetParent(MenuBar *m) {
        parentmenu = m;
        menu.MaxIconSize(m->GetMaxIconSize());
    }
    void Set(Callback1<Bar&> _submenu) {
        proc = _submenu;
    }
    Callback1<Bar&> Get() {
        return proc;
