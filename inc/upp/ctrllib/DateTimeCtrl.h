...
public:
    ...
    virtual Value GetData() const {
        return time_mode ? (Time) sel : (Date) sel;
    }
    virtual void  SetData(const Value& v) {
        time_mode ? SetTime((Time) v) : SetDate((Date) v);
    }
    ...
    Date GetView() const {
        return Date(view.year, view.month, view.day ? view.day : 1);
    }
...
public:
    ...
    DateTimeCtrl& SelectAll(bool b = true) {
        cc.calendar.SelectAll(b);
        return *this;
    }
    DateTimeCtrl& NoSelectAll() {
        cc.calendar.SelectAll(false);
        return *this;
    }
    ...
    DateTimeCtrl& NoColon() {
        cc.clock.Colon(false);
        return *this;
    }
    DateTimeCtrl& SwapMonthYear(bool b = true) {
        cc.calendar.SwapMonthYear(b);
        return *this;
    }
    DateTimeCtrl& OneButton(bool b = true) {
        cc.calendar.OneButton(true);
        return *this;
    }
    DateTimeCtrl& NoOneButton() {
        cc.calendar.OneButton(false);
        return *this;
    }
...
public:
    ...
    DropTime& Seconds(bool b = true) {
        DateTimeCtrl<EditTime>::Seconds(b);
        EditTime::Seconds(b);
        return *this;
    }
    DropTime& NoSeconds() {
