...
public:
    ...
    ColorSelector& NotNull(bool nn = true) {
        impl->NotNull(nn);
        return *this;
    }
    ColorSelector& NoNotNull() {
        return NotNull(false);
    }
    bool           IsNotNull() const {
        return impl->IsNotNull();
    }
    ...
    Vector<Color>  GetPalette() const {
        return impl->GetPalette();
    }
    void           SetPalette(const Vector<Color>& palette) {
        impl->SetPalette(palette);
    }

    void           SerializeConfig(Stream& stream) {
        impl->SerializeConfig(stream);
    }

    virtual void   SetData(const Value& color) {
        Set(color);
    }
    virtual Value  GetData() const {
        return Get();
...
public:
    ...
    ColorCtrl&     NotNull(bool _nn = true) {
        empty.Show(!_nn);
        return *this;
    }
    ColorCtrl&     NoNotNull() {
