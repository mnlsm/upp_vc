...
public:
    friend U& operator -= (U& a, const V& b) {
        a += -b;
        return a;
    }
    friend U  operator + (const U& a, const V& b) {
        U x(a);
        x += b;
        return x;
    }
...
public:
    ...
    friend int  SgnCompare(const T& a, const T& b) {
        return a.Compare(b);
    }
};
...
struct CombineCompare {
    ...
    CombineCompare& operator()(const T& a, const T& b) {
        if(!result) result = SgnCompare(a, b);
        return *this;
    }
    ...
    template <class T>
    CombineCompare(const T& a, const T& b) {
        result = 0;
        operator()(a, b);
    }
};
...
template <class T>
inline void AssertMoveable(T *t = 0) {
    if(t) AssertMoveable0(t);
}
...
public:
    friend T *DeepCopyNew(const T& t) {
        return t.Copy();
    }
};
...
public:
    ...
    WithDeepCopy& operator=(const WithDeepCopy& a) {
        (T&)*this <<= a;
        return *this;
    }
    WithDeepCopy(int, pick_ T& a) : T(a)           {}
    WithDeepCopy& operator^=(pick_ T& a) {
        (T&)*this = a;
        return *this;
    }
    WithDeepCopy()                                 {}
...
public:
    ...
    ConstIIterator  operator++(int) {
        ConstIIterator t = *this;
        ++ii;
        return t;
    }
    ConstIIterator  operator--(int) {
    ...
    ConstIIterator  operator+(int d) const {
        return ConstIIterator(cont, ii + d);
    }
    ConstIIterator  operator-(int d) const {
        return ConstIIterator(cont, ii - d);
    }

    int  operator-(const ConstIIterator& b) const {
        return ii - b.ii;
    }

    bool operator==(const ConstIIterator& b) const {
        return ii == b.ii;
    }
    bool operator!=(const ConstIIterator& b) const {
        return ii != b.ii;
...
public:
    ...
    IIterator  operator+(int d) const {
        return IIterator(*cont, ii + d);
    }
    IIterator  operator-(int d) const {
        return IIterator(*cont, ii - d);
    }

    int  operator-(const IIterator& b) const {
        return ii - b.ii;
    }

    bool operator==(const IIterator& b) const {
        return ii == b.ii;
    }
    bool operator!=(const IIterator& b) const {
        return ii != b.ii;
...
template <class T>
inline unsigned GetHashValue(const T& x) {
...
struct CombineHash {
    ...
    template <class T> CombineHash& Do(const T& x) {
        Put(GetHashValue(x));
        return *this;
    }

public:
    CombineHash& Put(unsigned h) {
        hash = ((hash << 4) + hash) ^ h;
        return *this;
    }
    ...
    template <class T>
    CombineHash(const T& h1) {
        hash = INIT;
        Do(h1);
    }
    template <class T, class U>
    CombineHash(const T& h1, const U& h2) {
        hash = INIT;
        Do(h1);
        Do(h2);
    }
    template <class T, class U, class V>
    CombineHash(const T& h1, const U& h2, const V& h3) {
        hash = INIT;
        Do(h1);
        Do(h2);
        Do(h3);
    ...
    CombineHash(const T& h1, const U& h2, const V& h3, const W& h4) {
        hash = INIT;
        Do(h1);
        Do(h2);
        Do(h3);
...
template<> inline unsigned GetHashValue(const char& a) {
    return (unsigned)a;
}
template<> inline unsigned GetHashValue(const signed char& a) {
    return (const unsigned)a;
}
template<> inline unsigned GetHashValue(const unsigned char& a) {
    return (const unsigned)a;
}
template<> inline unsigned GetHashValue(const short& a) {
    return (const unsigned)a;
}
template<> inline unsigned GetHashValue(const unsigned short& a) {
    return (const unsigned)a;
}
template<> inline unsigned GetHashValue(const int& a) {
    return (const unsigned)a;
}
template<> inline unsigned GetHashValue(const unsigned int& a) {
    return (const unsigned)a;
}
template<> inline unsigned GetHashValue(const long& a) {
    return (const unsigned)a;
}
template<> inline unsigned GetHashValue(const unsigned long& a) {
    return (const unsigned)a;
}
template<> inline unsigned GetHashValue(const bool& a) {
    return (const unsigned)a;
}
template<> inline unsigned GetHashValue(const wchar_t& a) {
    return (const unsigned)a;
}

template<> inline unsigned GetHashValue(const int64& a) {
    return CombineHash((unsigned)a, (unsigned)(a >> 32));
}
template<> inline unsigned GetHashValue(const uint64& a) {
    return GetHashValue((int64)a);
}

unsigned GetHashValue0(const double& a);

template<> inline unsigned GetHashValue(const double& a) {
    return GetHashValue0(a);
}
template<> inline unsigned GetHashValue(const float& a) {
    double x = a;
    return GetHashValue0(x);
}

#ifdef CPU_32
inline unsigned GetPtrHashValue(const void *a) {
    return (int)a;
}
#else
inline unsigned GetPtrHashValue(const void *a) {
    return CombineHash((unsigned)(uintptr_t)a);
}
#endif
...
template <class T> inline const T& ntl_max(const T& a, const T& b) {
    return a > b ? a : b;
}
