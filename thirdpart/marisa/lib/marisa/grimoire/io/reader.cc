...
#include "lib/marisa/grimoire/io/reader.h"
...
#else // #ifdef MARISA_SUPPORT_CPP_STREAM
Reader::Reader()
    : file_(NULL), fd_(-1), needs_fclose_(false) {}
#endif // #ifdef MARISA_SUPPORT_CPP_STREAM
